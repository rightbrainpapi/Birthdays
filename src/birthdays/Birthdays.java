 ...
 * Description:
 *
 * This program is expected to take two dates (a persons date of birth and the
 * current year) Then the program calculates the age of the person based on the
 * given data.
 *
 * Challenges This program was fairly simple. My main challenge was getting the
 * syntax correct for decimal inserts.
 *
 *
 * KEYWORD - WHILE LOOP - starts with a condition and includes compound
 * statements
 */
